return {
    Id = "Visuals", Label = "Visuals", Icon = "eye", Bookmarked = true,
    Sections = {
        { Title = "ESP Settings", Icon = "eye", Controls = {
