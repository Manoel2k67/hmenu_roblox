...
```lua
local sources = {
    "https://raw.githubusercontent.com/Manoel2k67/hmenu_roblox/main/KeySystem.lua?v=1.1.0",
    "https://cdn.jsdelivr.net/gh/Manoel2k67/hmenu_roblox@main/KeySystem.lua?v=1.1.0",
}
